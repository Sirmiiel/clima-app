...
window.onload = function() {
  ...
  document.querySelector('#rot-icons').addEventListener('click', () => {
    ...
    // Pause all audio elements before playing the corresponding one
    document.querySelectorAll('audio').forEach(audio => audio.pause());

    // Play the corresponding audio based on the index
    ...
    if (index == 0 ) {
      ...
      document.getElementById('audio-snow').play();
    }
